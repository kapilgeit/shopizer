					...
					<form:form method="post" action="${register_url}"
						...
						<fieldset>
							<div class="control-group form-group">
								<label class="required control-label" for="FirstNameRegister"><s:message
								...
								<div class="controls">
									...
									<form:input path="billing.firstName"
										cssClass="span8 required input form-control form-control-md"
										id="firstName" title="${msgFirstName}" />
									<form:errors path="billing.firstName" cssClass="error" />

								</div>
							</div>
							<div class="control-group form-group">
								<label class="required control-label" for="LastNameRegister"><s:message
										code="label.generic.lastname" text="Last Name" /></label>
								<div class="controls">
							...
							<div class="control-group form-group">
								<label class="required control-label" for="sex"><s:message
										code="label.generic.genre" text="Genre" /></label>
								<div class="controls">
							...
							<div class="control-group form-group">
								<label class="control-label required"><s:message
										code="label.generic.country" text="Country" /></label>
								<div class="controls">
									<form:select path="billing.country"
										class="form-control" id="registration_country">
							...
							<div class="control-group form-group">
								<label class="control-label required"><s:message
										code="label.generic.stateprovince" text="State / Province" /></label>
								<div class="controls">
									...
									<form:input path="billing.stateProvince"
										cssClass="span8 required form-control form-control-md"
										id="hidden_zones" title="${msgStateProvince}" />
								</div>
							</div>


							<div class="control-group form-group">
								<label class="required control-label" for="username"><s:message
							...
							<div class="control-group form-group">
								<label class="required control-label" for="email"><s:message
										code="label.generic.email" text="Email address" /></label>
								<div class="controls">
							...
							<div class="control-group form-group">
								<label class="required control-label" for="password"><s:message
										code="label.generic.password" text="Password" /></label>
								<div class="controls">
							...
							<div class="control-group form-group">
								<label class="required control-label" for="passwordAgain"><s:message
										code="label.generic.repeatpassword" text="Repeat password" /></label>
								<div class="controls">
							...
							<div class="control-group form-group">
								<div class="controls">
									...
									<script
										src="https://www.google.com/recaptcha/api.js?hl=<c:out value="${requestScope.LANGUAGE.code}"/>"
										async defer></script>

									<div class="g-recaptcha"
										data-sitekey="<c:out value="${recapatcha_public_key}"/>"></div>
							...
							<div class="form-actions">
								<input id="submitRegistration" type="submit"
									value="<s:message code="label.generic.register" text="Register"/>"
									name="register" class="btn btn-large">
							</div>
							<!--
									
								<button id="submitRegistration" type="submit" class="btn btn-default acc_btn" name="register"  > 
				...
				<div class="create_account_area">
					...
					<div class="caa_form_group">
							...
							<p class="forgot_password">
								<a href="#" title="Recover your forgotten password" rel="">Forgot
									your password?</a>
							</p>
							<button type="submit" id="acc_Login"
								class="btn btn-default acc_btn">
								<span> <i class="fa fa-lock btn_icon"></i> Sign in
								</span>
							</button>
						</div>
					 -->
...
<div id="main-content" class="container clearfix row-fluid">
	...
	<div class="span7 col-md-7 no-padding">
		<form:form method="post" action="${register_url}"
			id="registrationForm" class="form-horizontal" commandName="customer">
			<form:errors path="*"
...
<!-- 
	<div id="why-join" class="span4 offset1 col-md-5">
		<h3 class="short_headline">
			<span><s:message code="label.register.whyregister"
					text="Why register?" /></span>
		</h3>
		<p>
			<s:message code="label.register.registerreasons"
				text="Simplify a checkout process by having your information pre-filed, re-order an item from one click and get access to premium information." />
		</p>
	</div>
</div>
 -->

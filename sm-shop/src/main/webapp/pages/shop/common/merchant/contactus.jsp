...
function sendContact(){
 ...
 function isFieldValid(field) {
	...
	<h1 class="contact-title"><s:message code="label.customer.contactus" text="Get in Touch"/></h1>
			...
			<div class="span6 col-md-7">  
                                ...
                                <form:form action="#" method="POST" id="contactForm" class="form-horizontal" name="contactForm" commandName="contact">
									...
									<div class="input-area submit-area">
										<input id="submitContact" type="button" value="<s:message code="label.generic.send" text="Send Message"/>" name="register" class="btn btn-large">
									</div>
									</fieldset>
			</form:form>
